...
const STEPS = [
  ...
  { step: '3', title: 'Trade stocks & ETFs', desc: 'Search and buy/sell stocks from markets worldwide.' },
  { step: '4', title: 'Climb the leaderboard', desc: 'The best portfolio value wins when time is up.' },
];

const MARKETS = ['AAPL', 'TSLA', 'SAP.DE', 'SPY', 'NVDA', 'BMW.DE', 'QQQ', 'MSFT', 'VUSA.DE'];
    ...
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden py-24 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-xl text-muted max-w-2xl mx-auto mb-6 leading-relaxed">
            Compete with friends using virtual money on real market prices. Trade US stocks, European equities, S&P 500 ETFs and more. Create rooms, set your timeframe, and see who builds the best portfolio.
          </p>

          {/* Ticker strip */}
          <div className="flex flex-wrap justify-center gap-2 mb-10">
            {MARKETS.map((ticker) => (
              <span key={ticker} className="bg-surface border border-border rounded-lg px-3 py-1 text-xs font-mono text-muted-bright">
                {ticker}
              </span>
            ))}
            <span className="bg-surface border border-border rounded-lg px-3 py-1 text-xs font-mono text-muted">
              + thousands more
            </span>
          </div>
      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-muted mb-8">Join and compete using live global stock market data.</p>
          <Link
            href="/register"
